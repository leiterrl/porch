...
from experiments.mor_pinn.wave_eq_explicit_data import run_model
...
if args.opt:
    ...
    config.model_dir = (
        "/import/sgs.local/scratch/leiterrl/h_param_wave_eq_pinn_mor_expl_opt"
    )
elif args.lra:
    config.lra = True
    config.model_dir = (
        "/import/sgs.local/scratch/leiterrl/h_param_wave_eq_pinn_mor_expl_lra"
    )
else:
    config.model_dir = (
        "/import/sgs.local/scratch/leiterrl/h_param_wave_eq_pinn_mor_expl_equal"
    )
